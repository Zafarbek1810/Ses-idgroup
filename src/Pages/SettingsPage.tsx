  ...
  return (
    <main className="flex-1 overflow-y-auto p-6 space-y-5 ses-scrollbar">
      ...
      <div>
        ...
        <p className="text-sm text-muted-foreground mt-0.5">Interfeys va ko'rinishni sozlang</p>
      </div>

      <div className="bg-card rounded-2xl border border-border shadow-sm p-6 max-w-xl space-y-6">
        <div>
